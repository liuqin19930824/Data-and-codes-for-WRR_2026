...
#' 
#' @param df A data frame containing observational data for all the predictors and training variables.
#'  One variable among predictors has to be soil moisture \code{"soilm"}. 
